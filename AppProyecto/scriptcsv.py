    ...
    if connection.is_connected():
        ...
        with open('C:\\Users\\carolnet\\Desktop\\appProyecto\\songs.csv', 'r', encoding='utf-8') as file:
            ...
            for line in file:
                ...
                cursor.execute('INSERT INTO canciones (title, artist, top_genre, year, bpm, energy, danceability, dB, liveness, valence, duration, acousticness, speechiness, popularity) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)', data)
